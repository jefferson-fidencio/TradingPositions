...
namespace OperationsWF
{
    public partial class AddPositionForm : Form
    {
        ...
        CheckBox checkBoxParcial = new CheckBox();
        ...
        Label labelPercentCapital = new Label();
        ...
        private void DrawForm()
        {
            ...
            comboBoxFerramenta.SelectedIndex = 0;
            ...
            labelTipoTrade.Location = new System.Drawing.Point(480, 19);
            ...
            comboBoxTipoTrade.SelectedIndex = 0;
    ...
    "____________________________";
            ...
            comboBoxTipoPosicao.SelectedIndex = 0;
            comboBoxTipoPosicao.TabIndex = 7;
            comboBoxTipoPosicao.SelectedIndexChanged += AtualizarTipoPosicao;
            // 
            // label10
            // 
            ...
            textBoxCapital.Text = Program.myHistory.saldo;
            textBoxCapital.TabIndex = 9;
            textBoxCapital.TextChanged += AtualizarCapital;
            // 
            // labelPercentCapital
            // 
            labelPercentCapital.AutoSize = true;
            labelPercentCapital.ForeColor = Color.Green;
            labelPercentCapital.Location = new System.Drawing.Point(228, label12.Location.Y + 2);
            labelPercentCapital.Name = "labelPercentCapital";
            labelPercentCapital.Size = new System.Drawing.Size(102, 13);
            labelPercentCapital.Text = " % do capital total";
            // 
    ...
    "____________________________";
            ...
            labelPar.Location = new System.Drawing.Point(6, 215);
            ...
            label19.Location = new System.Drawing.Point(6, 238);
            ...
            textBoxEntrada.TextChanged += AtualizarEntrada;
            // 
            // label20
            // 
            ...
            label20.Location = new System.Drawing.Point(6, 263);
            ...
            label21.Location = new System.Drawing.Point(6, 288);
            ...
            label31.Location = new System.Drawing.Point(6, 313);
            ...
            // checkBoxParcial
            // 
            checkBoxParcial.Location = new System.Drawing.Point(80, 308);
            checkBoxParcial.Name = "checkBoxParcial";
            checkBoxParcial.CheckedChanged += CheckBoxParcial_CheckedChanged; ;
            // 
            // textBoxParcial
            // 
            textBoxParcial.Location = new System.Drawing.Point(105, 310);
            textBoxParcial.Name = "textBoxParcial";
            textBoxParcial.Size = new System.Drawing.Size(125, 13);
            textBoxParcial.TabIndex = 16;
            textBoxParcial.Text = "0.00000000";
            ...
            Controls.Add(labelPercentCapital);
        ...
        private void AtualizarEntrada(object sender, EventArgs e)
        {
            position.Entrada = textBoxEntrada.Text;
            AtualizarCalculados(null, null);
        }

        private void AtualizarCapital(object sender, EventArgs e)
        {
            position.Capital = textBoxCapital.Text;
            AtualizarCalculados(null, null);
        }

        private void AtualizarTipoPosicao(object sender, EventArgs e)
        {
            position.TipoPosicao = comboBoxTipoPosicao.Text;
            AtualizarCalculados(null, null);
        }

        private void CheckBoxParcial_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void RecalcularPorcentagemCapital()
        {
            try
            {
                float percent = 0;
                float capitalTotal = float.Parse(Program.myHistory.saldo, CultureInfo.InvariantCulture.NumberFormat);
                float capital = float.Parse(textBoxCapital.Text, CultureInfo.InvariantCulture.NumberFormat);
                percent = capital * 100 / capitalTotal;

                labelPercentCapital.Text = percent.ToString("0.00") + "% do capital total";
        ...
        {
            //atualiza dados
            position.Par1 = comboBoxPar1.Text;
            position.Par2 = comboBoxPar2.Text;
            position.Exchange = comboBoxExchange.Text;
            position.Ferramenta = comboBoxFerramenta.Text;
            position.Tecnica = comboBoxTecnica.Text;
            position.TipoTrade = comboBoxTipoTrade.Text;
            position.DataAbertura = textBoxData.Text;
            position.HoraAbertura = textBoxHora.Text;
            ...
            position.Indicadores = indicadores;

            //atualiza historico
            ArrayList historico = new ArrayList {
                    String.Format(DateTime.Now.ToString("dd/MM/yyyy - HH:mm -> ") + "Posição aberta no par {0}, seguindo relação risco/ganho de {3}. \r\nEntrada: {4}, Alvo: {5}, Stop: {6}, Parcial: {7}. \r\nCapital aplicado de {8} utilizando técnica {9}.",
        ...
        private float calculaRiscoPercent()
        {
            ...
            if (comboBoxTipoPosicao.Text != "Short position")
                riscoPercent = ((entrada - stop) * 100 / entrada);
            else
                riscoPercent = ((stop - entrada) * 100 / entrada);
            return riscoPercent;
        }

        private float calculaGanhoPercent()
        {
            float ganhoPercent = 0;
            float alvo = float.Parse(textBoxAlvo.Text, CultureInfo.InvariantCulture.NumberFormat);
            float entrada = float.Parse(textBoxEntrada.Text, CultureInfo.InvariantCulture.NumberFormat);
            if (comboBoxTipoPosicao.Text == "Short position")
                ganhoPercent = (entrada - alvo) * 100 / entrada;
            else
                ganhoPercent = (alvo - entrada) * 100 / entrada;
            return ganhoPercent;
        }
        ...
        {
            float parcialPercent = 0;
            float parcial = float.Parse(textBoxParcial.Text, CultureInfo.InvariantCulture.NumberFormat);
            float entrada = float.Parse(textBoxEntrada.Text, CultureInfo.InvariantCulture.NumberFormat);
            if (comboBoxTipoPosicao.Text == "Short position")
                parcialPercent = (entrada - parcial) * 100 / entrada;
            else
                parcialPercent = (parcial - entrada) * 100 / entrada;
            return parcialPercent;
        }
